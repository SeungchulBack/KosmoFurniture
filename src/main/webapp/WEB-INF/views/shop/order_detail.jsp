...
<div class="jumbotron m-4">
        ...
        <c:forEach var="dto" items="${dtos}">
            <tr>
                <td class="align-middle">
                    <a href="/admin/products/${dto.product.productId}">${dto.product.name}</a>
                </td>
                <td class="align-middle">
                        ${dto.product.price}
                </td>
                ...
                <td>
                    <img src="/files/${dto.imageFileName}" style="width:150px;height:auto">
                </td>
            </tr>
        </c:forEach>
        </tbody>
    ...
    <div class="text-center mt-3">
        <form action="/shop/order/cancel" method="post">
            <input
