...
<div class="container-fluid">
    <div class="row align-items-start">
        ...
        <div class="col-10">
				<a class="btn btn-primary mr-5 my-1" href="/admin/serviceboard-write" role="button">고객질문 등록</a>
                <table class="table">
                    ...
                    <tbody>
                    <c:forEach var="serviceboard" items="${serviceboardList}">
                        <tr>
                            <td class="text-center">
                                    ${serviceboard.serviceboardId}
                            </td>
                            <td class="text-center">
                                <a href="/admin/serviceboard/${serviceboard.serviceboardId}">${serviceboard.title}</a>
                            </td>
...
<script>
    ...
    function PageMove(page) {
        ...
        location.href = "/admin/serviceboard?pageNum=" + page + "&pageSize=" + pageSize;
    }
