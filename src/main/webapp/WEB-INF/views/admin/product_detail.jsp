    ...
    <script>
        ...
        function confirm_reply(b_reply_num) {
            $.ajax({
                ...
                type: 'post',
                data: {
                    "b_reply_content": $('#reply_area_' + b_reply_num).val(),
                    "b_reply_num": b_reply_num
                },
                success: function (data) {
                    // console.log(data) // 전체 html이 데이터로 넘어온다
                ...
                <c:if test="${!empty imageBean}">
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <c:out value="이미지 갯수 : ${imageBean.size()}"></c:out>
                            <c:forEach var="pic" items="${imageBean}" varStatus="a">
                ...
                <div>
                    ...
                    <c:if test="${!empty sessionScope.id}">
                        <c:if test="${favorite=='favorite'}">
                            <img class="favorite" src="./resources/image/icon/star_on.png"
                                 style="width:30px;height:auto;">
                            <input type="hidden" id="favorite" value="none">
                        </c:if>
                        <c:if test="${favorite=='none'}">
                            <img class="favorite" src="./resources/image/icon/star_off.png"
                                 style="width:30px;height:auto;">
                        ...
                        <c:if test="${like=='none'}">
                            <img class="like" src="./resources/image/icon/heart_off.png"
                                 style="width:30px;height:auto;">
                            <input type="hidden" id="like" value="like">
                            <span id="like_num"></span>
                        </c:if>

                        <img id="board_${boardBean.board_num}" onclick="check_report(${boardBean.board_num},'board')"
                             src="./resources/image/icon/siren_on.png" style="width:30px;height:auto">
                ...
                <div class="row">
                    ...
                    <c:if test="${boardBean.join_id==sessionScope.id||sessionScope.id=='admin'}">
                        <div class="col">
                            ...
                            <input type="button" value='수정하기' onclick="$('#board_modify_action').submit()"
                                   class="btn btn-info">
                        ...
                        <div id="ajax_reply_${list.b_reply_num}">
                            <div class="row">
                                ...
                                <c:if test="${list.b_reply_state!=1}">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea style="resize:none;" rows="3" name="b_reply_content" readonly
                                                  id="reply_area_${list.b_reply_num }"
                                                  class="form-control">${list.b_reply_content}</textarea>
                                    </div>
                                ...
                                <div>
                                    <c:if test="${!empty sessionScope.id}">
                                        <img id="reply_${list.b_reply_num}"
                                             onclick="check_report('${list.b_reply_num}','reply')"
                                             src="./resources/image/icon/siren_on.png" style="width:20px;height:auto;">
                                    </c:if>
                                    <c:if test="${sessionScope.id==list.join_id&&list.b_reply_state!=1||sessionScope.id=='admin'}">

                                        <img src="./resources/image/icon/modify.png"
                                             onclick="modify_reply('${list.b_reply_num}')"
                                             id="modify_reply_button_${list.b_reply_num}"
                                        ...
                                        <img src="./resources/image/icon/confirm.png"
                                             onclick="confirm_reply('${list.b_reply_num}')"
                                             id="confirm_reply_button_${list.b_reply_num}"
                                        ...
                                        <img src="./resources/image/icon/delete.png"
                                             onclick="delete_reply_button('${list.b_reply_num}')"
                                             id="delete_reply_button_${list.b_reply_num }"
                                             style="width:25px;height:auto">
